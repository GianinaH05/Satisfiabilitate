...
void setare(char * linie,setclauze *set)
{
    ...
    if(set->clauze==NULL)
    {
        printf("nu sa putut crea spatiu pentru clauze.\n");
    }
    if(set->singular==NULL)
    {
        printf("nu sa putut crea spatiu pentru clauzele cu un literal\n");
    }
    if(set->pur==NULL)
    {
                    ...
                    if(c.total!=0)
                    {
                        if(!tautologie(c) && clauzanoua(*set,c))
                        {
                            ...
                            if(c.total==1)
                            {
                                ...
                                if(c.literali[0]>0)
                                {
                                    set->singular[set->nrliterali+c.literali[0]-1]++;
                                }
                                else
                                {
                                    set->singular[abs(c.literali[0])-1]++;
                                }
                                dplit=1;
                            }
                            set->n++;
...
int main()
{
    ...
    printf("Clauze cu un literal create: %d \n",litsingur);
